...
public class Bank implements Serializable, Comparable
  ...
  ************************************************************************/
  ...
  public int compareTo(Object other)	//check Name, then check ID, then check Address
   {
		int result;
		if (bankName.equals(((Bank) other).bankName))
			if (bankID == (((Bank) other).bankID))
		    	result = bankAddress.compareTo(((Bank) other).bankAddress);
		        else
		         result = bankID - (((Bank) other).bankID);
		else
		 result = bankName.compareTo(((Bank) other).bankName);
